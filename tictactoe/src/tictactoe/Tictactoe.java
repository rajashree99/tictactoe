...
c2=new Checkbox("you vs your Friend",cbg,false);
...
ic1=new ImageIcon("x.jpg");
ic2=new ImageIcon("o.jpg");
ic11=new ImageIcon("x1.jpg");
ic22=new ImageIcon("o1.jpg");
...
for(i=0;i<=7;i++){
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();
	...
	JOptionPane.showMessageDialog(Tictactoe.this,"X WON ! click reset.");			
	 break;
                   }
             else if(icon1==ic2){ 
             ...
             b[(a[i][3]-1)].setIcon(ic22); 
               JOptionPane.showMessageDialog(Tictactoe.this,"O WON ! click reset.");
                break;			 
               }
         }
    }  
